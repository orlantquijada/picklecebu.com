...
2026-05-02 — Booking bar date picker — Installed react-day-picker v9, added shadcn Calendar component (calendar.tsx), replaced non-interactive date divs in booking-bar.tsx (mobile + desktop) with Popover+Calendar; fixed useBookingBarState to track localDate and handle date in update(); typecheck clean. — UI verification requires browser.
